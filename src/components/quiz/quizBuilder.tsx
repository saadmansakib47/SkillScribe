    ...
    return (
      <div className="mt-10 bg-[#fdfaf7] p-6 rounded-[8px]">
        ...
        {questions.map((q, qi) => (
          <div
            key={q.id}
            className="border-2 border-blue-200 rounded-[8px] p-4 mb-4"
          >
            ...
            <div className="space-y-2">
              {q.options.map((opt, oi) => (
                <div
                  key={opt.id}
                  className="flex items-center gap-2 bg-white border border-gray-300 rounded-[8px] px-3 py-2 hover:bg-gray-50 cursor-pointer"
                >
        ...
        <div className="flex justify-end mt-6">
          <Button
            ...
            className="bg-gray-300 text-gray-800 hover:bg-gray-400 rounded-[8px]"
          >
            Exit Preview
          </Button>
        </div>
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        <div className="flex gap-3">
          <Button
            ...
            className="bg-gray-200 text-gray-700 hover:bg-gray-300 rounded-[8px]"
          >
            Preview
          </Button>
          ...
          <Button
            ...
            className="bg-green-500 text-white hover:bg-green-600 rounded-[8px]"
          >
            Publish Quiz
          </Button>
        </div>
