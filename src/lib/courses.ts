    ...
    modules: [
      {
        ...
        duration: '5 hr',
        topics: [
          { id: 1, title: 'ML workflow', resources: [{ title: 'ML overview', size: '200 KB', file: '/Asset/resources/ml/workflow.pdf' }] },
          { id: 2, title: 'Data preprocessing', resources: [{ title: 'Preprocessing guide', size: '220 KB', file: '/Asset/resources/ml/preprocessing.pdf' }] },
          { id: 3, title: 'Feature engineering', resources: [{ title: 'Feature engineering', size: '240 KB', file: '/Asset/resources/ml/features.pdf' }] },
          { id: 4, title: 'Model evaluation', resources: [{ title: 'Evaluation metrics', size: '180 KB', file: '/Asset/resources/ml/evaluation.pdf' }] },
          { id: 5, title: 'Cross-validation', resources: [{ title: 'Validation techniques', size: '160 KB', file: '/Asset/resources/ml/validation.pdf' }] },
        ],
      },
      {
        id: 2,
        ...
        duration: '6 hr',
        topics: [
          { id: 1, title: 'Linear regression', resources: [{ title: 'Regression guide', size: '190 KB', file: '/Asset/resources/ml/regression.pdf' }] },
          { id: 2, title: 'Logistic regression', resources: [{ title: 'Logistic models', size: '180 KB', file: '/Asset/resources/ml/logistic.pdf' }] },
          { id: 3, title: 'Decision trees', resources: [{ title: 'Tree models', size: '200 KB', file: '/Asset/resources/ml/trees.pdf' }] },
          { id: 4, title: 'Random forests', resources: [{ title: 'Ensemble methods', size: '220 KB', file: '/Asset/resources/ml/forests.pdf' }] },
          { id: 5, title: 'Support Vector Machines', resources: [{ title: 'SVM guide', size: '210 KB', file: '/Asset/resources/ml/svm.pdf' }] },
          { id: 6, title: 'Gradient boosting', resources: [{ title: 'Boosting algorithms', size: '230 KB', file: '/Asset/resources/ml/boosting.pdf' }] },
        ],
      },
      {
        id: 3,
        ...
        duration: '4.5 hr',
        topics: [
          { id: 1, title: 'K-means clustering', resources: [{ title: 'Clustering basics', size: '180 KB', file: '/Asset/resources/ml/kmeans.pdf' }] },
          { id: 2, title: 'Hierarchical clustering', resources: [{ title: 'Hierarchical methods', size: '190 KB', file: '/Asset/resources/ml/hierarchical.pdf' }] },
          { id: 3, title: 'DBSCAN', resources: [{ title: 'Density-based clustering', size: '170 KB', file: '/Asset/resources/ml/dbscan.pdf' }] },
          { id: 4, title: 'PCA & dimensionality reduction', resources: [{ title: 'Dimensionality reduction', size: '200 KB', file: '/Asset/resources/ml/pca.pdf' }] },
          { id: 5, title: 'Anomaly detection', resources: [{ title: 'Anomaly detection', size: '180 KB', file: '/Asset/resources/ml/anomaly.pdf' }] },
        ],
      },
      {
        id: 4,
        ...
        duration: '6 hr',
        topics: [
          { id: 1, title: 'Neural networks basics', resources: [{ title: 'NN fundamentals', size: '220 KB', file: '/Asset/resources/ml/neural-nets.pdf' }] },
          { id: 2, title: 'TensorFlow & Keras', resources: [{ title: 'TensorFlow guide', size: '250 KB', file: '/Asset/resources/ml/tensorflow.pdf' }] },
          { id: 3, title: 'CNNs for computer vision', resources: [{ title: 'Convolutional networks', size: '240 KB', file: '/Asset/resources/ml/cnn.pdf' }] },
          { id: 4, title: 'RNNs & LSTMs', resources: [{ title: 'Recurrent networks', size: '230 KB', file: '/Asset/resources/ml/rnn.pdf' }] },
          { id: 5, title: 'Transfer learning', resources: [{ title: 'Transfer learning', size: '210 KB', file: '/Asset/resources/ml/transfer.pdf' }] },
          { id: 6, title: 'Model deployment', resources: [{ title: 'Deployment guide', size: '200 KB', file: '/Asset/resources/ml/deploy.pdf' }] },
        ],
      },
    ],
    whatYouWillLearn: [
    ...
    modules: [
      {
        ...
        duration: '4.5 hr',
        topics: [
          { id: 1, title: 'Modern syntax', resources: [{ title: 'C++ syntax', size: '180 KB', file: '/Asset/resources/cpp/syntax.pdf' }] },
          { id: 2, title: 'References & pointers', resources: [{ title: 'Pointers guide', size: '170 KB', file: '/Asset/resources/cpp/pointers.pdf' }] },
          { id: 3, title: 'Classes & OOP', resources: [{ title: 'OOP in C++', size: '200 KB', file: '/Asset/resources/cpp/oop.pdf' }] },
          { id: 4, title: 'Constructors & RAII', resources: [{ title: 'RAII pattern', size: '160 KB', file: '/Asset/resources/cpp/raii.pdf' }] },
          { id: 5, title: 'Operator overloading', resources: [{ title: 'Operators', size: '140 KB', file: '/Asset/resources/cpp/operators.pdf' }] },
        ],
      },
      {
        id: 2,
        ...
        duration: '5 hr',
        topics: [
          { id: 1, title: 'Smart pointers', resources: [{ title: 'Smart pointers guide', size: '190 KB', file: '/Asset/resources/cpp/smart-pointers.pdf' }] },
          { id: 2, title: 'Move semantics', resources: [{ title: 'Move & rvalue', size: '200 KB', file: '/Asset/resources/cpp/move.pdf' }] },
          { id: 3, title: 'Lambda expressions', resources: [{ title: 'Lambdas', size: '170 KB', file: '/Asset/resources/cpp/lambdas.pdf' }] },
          { id: 4, title: 'Templates', resources: [{ title: 'Template guide', size: '210 KB', file: '/Asset/resources/cpp/templates.pdf' }] },
          { id: 5, title: 'C++17/20 features', resources: [{ title: 'Modern C++', size: '220 KB', file: '/Asset/resources/cpp/modern.pdf' }] },
        ],
      },
      {
        id: 3,
        ...
        duration: '4.5 hr',
        topics: [
          { id: 1, title: 'STL containers', resources: [{ title: 'Containers guide', size: '200 KB', file: '/Asset/resources/cpp/containers.pdf' }] },
          { id: 2, title: 'Algorithms', resources: [{ title: 'STL algorithms', size: '190 KB', file: '/Asset/resources/cpp/algorithms.pdf' }] },
          { id: 3, title: 'Iterators', resources: [{ title: 'Iterator patterns', size: '160 KB', file: '/Asset/resources/cpp/iterators.pdf' }] },
          { id: 4, title: 'Concurrency', resources: [{ title: 'Threading', size: '200 KB', file: '/Asset/resources/cpp/concurrency.pdf' }] },
          { id: 5, title: 'Performance tuning', resources: [{ title: 'Optimization', size: '180 KB', file: '/Asset/resources/cpp/performance.pdf' }] },
        ],
      },
    ],
    whatYouWillLearn: [
    ...
    modules: [
      {
        ...
        duration: '3.5 hr',
        topics: [
          { id: 1, title: 'Syntax & types', resources: [{ title: 'Go syntax', size: '150 KB', file: '/Asset/resources/go/syntax.pdf' }] },
          { id: 2, title: 'Functions & methods', resources: [{ title: 'Functions guide', size: '160 KB', file: '/Asset/resources/go/functions.pdf' }] },
          { id: 3, title: 'Interfaces', resources: [{ title: 'Interfaces explained', size: '180 KB', file: '/Asset/resources/go/interfaces.pdf' }] },
          { id: 4, title: 'Error handling', resources: [{ title: 'Error patterns', size: '140 KB', file: '/Asset/resources/go/errors.pdf' }] },
          { id: 5, title: 'Packages & modules', resources: [{ title: 'Module system', size: '130 KB', file: '/Asset/resources/go/modules.pdf' }] },
        ],
      },
      {
        id: 2,
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'Goroutines', resources: [{ title: 'Goroutines guide', size: '190 KB', file: '/Asset/resources/go/goroutines.pdf' }] },
          { id: 2, title: 'Channels', resources: [{ title: 'Channels patterns', size: '200 KB', file: '/Asset/resources/go/channels.pdf' }] },
          { id: 3, title: 'Select statement', resources: [{ title: 'Select guide', size: '150 KB', file: '/Asset/resources/go/select.pdf' }] },
          { id: 4, title: 'Sync primitives', resources: [{ title: 'Sync package', size: '170 KB', file: '/Asset/resources/go/sync.pdf' }] },
          { id: 5, title: 'Concurrency patterns', resources: [{ title: 'Go patterns', size: '180 KB', file: '/Asset/resources/go/patterns.pdf' }] },
        ],
      },
      {
        id: 3,
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'HTTP servers', resources: [{ title: 'HTTP in Go', size: '180 KB', file: '/Asset/resources/go/http.pdf' }] },
          { id: 2, title: 'REST APIs', resources: [{ title: 'REST guide', size: '190 KB', file: '/Asset/resources/go/rest.pdf' }] },
          { id: 3, title: 'gRPC services', resources: [{ title: 'gRPC with Go', size: '210 KB', file: '/Asset/resources/go/grpc.pdf' }] },
          { id: 4, title: 'Database access', resources: [{ title: 'Database guide', size: '170 KB', file: '/Asset/resources/go/database.pdf' }] },
          { id: 5, title: 'Testing & deployment', resources: [{ title: 'Testing & deploy', size: '200 KB', file: '/Asset/resources/go/testing.pdf' }] },
        ],
      },
    ],
    whatYouWillLearn: [
    ...
    modules: [
      {
        ...
        duration: '5 hr',
        topics: [
          { id: 1, title: 'Spring Boot intro', resources: [{ title: 'Boot overview', size: '180 KB', file: '/Asset/resources/java/spring-intro.pdf' }] },
          { id: 2, title: 'Dependency injection', resources: [{ title: 'DI explained', size: '200 KB', file: '/Asset/resources/java/di.pdf' }] },
          { id: 3, title: 'Configuration', resources: [{ title: 'App config', size: '160 KB', file: '/Asset/resources/java/config.pdf' }] },
          { id: 4, title: 'Spring MVC', resources: [{ title: 'MVC guide', size: '190 KB', file: '/Asset/resources/java/mvc.pdf' }] },
          { id: 5, title: 'REST controllers', resources: [{ title: 'REST APIs', size: '180 KB', file: '/Asset/resources/java/rest.pdf' }] },
        ],
      },
      {
        id: 2,
        ...
        duration: '5 hr',
        topics: [
          { id: 1, title: 'Spring Data JPA', resources: [{ title: 'JPA guide', size: '220 KB', file: '/Asset/resources/java/jpa.pdf' }] },
          { id: 2, title: 'Hibernate', resources: [{ title: 'Hibernate basics', size: '200 KB', file: '/Asset/resources/java/hibernate.pdf' }] },
          { id: 3, title: 'Database migrations', resources: [{ title: 'Flyway guide', size: '150 KB', file: '/Asset/resources/java/migrations.pdf' }] },
          { id: 4, title: 'Transactions', resources: [{ title: 'Transaction management', size: '180 KB', file: '/Asset/resources/java/transactions.pdf' }] },
          { id: 5, title: 'Caching', resources: [{ title: 'Spring Cache', size: '160 KB', file: '/Asset/resources/java/cache.pdf' }] },
        ],
      },
      {
        id: 3,
        ...
        duration: '5 hr',
        topics: [
          { id: 1, title: 'Spring Security', resources: [{ title: 'Security basics', size: '210 KB', file: '/Asset/resources/java/security.pdf' }] },
          { id: 2, title: 'JWT authentication', resources: [{ title: 'JWT guide', size: '190 KB', file: '/Asset/resources/java/jwt.pdf' }] },
          { id: 3, title: 'Microservices patterns', resources: [{ title: 'Microservices', size: '220 KB', file: '/Asset/resources/java/microservices.pdf' }] },
          { id: 4, title: 'Spring Cloud', resources: [{ title: 'Cloud features', size: '200 KB', file: '/Asset/resources/java/cloud.pdf' }] },
          { id: 5, title: 'Docker & K8s', resources: [{ title: 'Deployment', size: '230 KB', file: '/Asset/resources/java/deploy.pdf' }] },
        ],
      },
    ],
    whatYouWillLearn: [
    ...
    modules: [
      {
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'Syntax & basics', resources: [{ title: 'Rust syntax guide', size: '180 KB', file: '/Asset/resources/rust/syntax.pdf' }] },
          { id: 2, title: 'Ownership & borrowing', resources: [{ title: 'Ownership model', size: '200 KB', file: '/Asset/resources/rust/ownership.pdf' }] },
          { id: 3, title: 'Structs & enums', resources: [{ title: 'Data structures', size: '160 KB', file: '/Asset/resources/rust/structs.pdf' }] },
          { id: 4, title: 'Error handling', resources: [{ title: 'Result & Option', size: '140 KB', file: '/Asset/resources/rust/errors.pdf' }] },
          { id: 5, title: 'Pattern matching', resources: [{ title: 'Pattern matching guide', size: '150 KB', file: '/Asset/resources/rust/patterns.pdf' }] },
        ],
      },
      {
        id: 2,
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'Lifetimes', resources: [{ title: 'Lifetimes explained', size: '190 KB', file: '/Asset/resources/rust/lifetimes.pdf' }] },
          { id: 2, title: 'Traits & generics', resources: [{ title: 'Traits system', size: '180 KB', file: '/Asset/resources/rust/traits.pdf' }] },
          { id: 3, title: 'Smart pointers', resources: [{ title: 'Smart pointers guide', size: '170 KB', file: '/Asset/resources/rust/pointers.pdf' }] },
          { id: 4, title: 'Concurrency', resources: [{ title: 'Fearless concurrency', size: '200 KB', file: '/Asset/resources/rust/concurrency.pdf' }] },
          { id: 5, title: 'Unsafe Rust', resources: [{ title: 'Unsafe code', size: '160 KB', file: '/Asset/resources/rust/unsafe.pdf' }] },
        ],
      },
      {
        id: 3,
        ...
        duration: '3.5 hr',
        topics: [
          { id: 1, title: 'CLI applications', resources: [{ title: 'CLI tools', size: '180 KB', file: '/Asset/resources/rust/cli.pdf' }] },
          { id: 2, title: 'Web servers', resources: [{ title: 'Web with Rust', size: '200 KB', file: '/Asset/resources/rust/web.pdf' }] },
          { id: 3, title: 'Testing & docs', resources: [{ title: 'Testing guide', size: '140 KB', file: '/Asset/resources/rust/testing.pdf' }] },
          { id: 4, title: 'Performance tuning', resources: [{ title: 'Optimization', size: '170 KB', file: '/Asset/resources/rust/performance.pdf' }] },
        ],
      },
    ],
    whatYouWillLearn: [
    ...
    modules: [
      {
        ...
        duration: '3 hr',
        topics: [
          { id: 1, title: 'Type annotations', resources: [{ title: 'Types intro', size: '140 KB', file: '/Asset/resources/ts/types.pdf' }] },
          { id: 2, title: 'Interfaces', resources: [{ title: 'Interfaces guide', size: '160 KB', file: '/Asset/resources/ts/interfaces.pdf' }] },
          { id: 3, title: 'Functions & types', resources: [{ title: 'Function types', size: '150 KB', file: '/Asset/resources/ts/functions.pdf' }] },
          { id: 4, title: 'Union & intersection', resources: [{ title: 'Type operators', size: '170 KB', file: '/Asset/resources/ts/operators.pdf' }] },
          { id: 5, title: 'Type guards', resources: [{ title: 'Guards & narrowing', size: '140 KB', file: '/Asset/resources/ts/guards.pdf' }] },
        ],
      },
      {
        id: 2,
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'Generics', resources: [{ title: 'Generics guide', size: '190 KB', file: '/Asset/resources/ts/generics.pdf' }] },
          { id: 2, title: 'Utility types', resources: [{ title: 'Utility types', size: '180 KB', file: '/Asset/resources/ts/utility.pdf' }] },
          { id: 3, title: 'Mapped types', resources: [{ title: 'Mapped types', size: '170 KB', file: '/Asset/resources/ts/mapped.pdf' }] },
          { id: 4, title: 'Conditional types', resources: [{ title: 'Conditional types', size: '200 KB', file: '/Asset/resources/ts/conditional.pdf' }] },
          { id: 5, title: 'Template literals', resources: [{ title: 'Template literal types', size: '160 KB', file: '/Asset/resources/ts/template-literals.pdf' }] },
        ],
      },
      {
        id: 3,
        ...
        duration: '2.5 hr',
        topics: [
          { id: 1, title: 'Decorators', resources: [{ title: 'Decorators guide', size: '170 KB', file: '/Asset/resources/ts/decorators.pdf' }] },
          { id: 2, title: 'TypeScript with React', resources: [{ title: 'React + TS', size: '190 KB', file: '/Asset/resources/ts/react.pdf' }] },
          { id: 3, title: 'Node.js with TypeScript', resources: [{ title: 'Node + TS', size: '180 KB', file: '/Asset/resources/ts/node.pdf' }] },
          { id: 4, title: 'Build configuration', resources: [{ title: 'TS config', size: '150 KB', file: '/Asset/resources/ts/config.pdf' }] },
        ],
      },
    ],
    whatYouWillLearn: [
    ...
    modules: [
      {
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'ES6+ syntax', resources: [{ title: 'ES6 features', size: '180 KB', file: '/Asset/resources/js/es6.pdf' }] },
          { id: 2, title: 'Arrow functions', resources: [{ title: 'Arrow functions', size: '140 KB', file: '/Asset/resources/js/arrows.pdf' }] },
          { id: 3, title: 'Destructuring', resources: [{ title: 'Destructuring guide', size: '150 KB', file: '/Asset/resources/js/destructuring.pdf' }] },
          { id: 4, title: 'Spread & rest', resources: [{ title: 'Spread operator', size: '130 KB', file: '/Asset/resources/js/spread.pdf' }] },
          { id: 5, title: 'Modules', resources: [{ title: 'ES modules', size: '160 KB', file: '/Asset/resources/js/modules.pdf' }] },
        ],
      },
      {
        id: 2,
        ...
        duration: '4.5 hr',
        topics: [
          { id: 1, title: 'Promises', resources: [{ title: 'Promise guide', size: '190 KB', file: '/Asset/resources/js/promises.pdf' }] },
          { id: 2, title: 'Async/await', resources: [{ title: 'Async patterns', size: '200 KB', file: '/Asset/resources/js/async.pdf' }] },
          { id: 3, title: 'Event loop', resources: [{ title: 'Event loop explained', size: '180 KB', file: '/Asset/resources/js/event-loop.pdf' }] },
          { id: 4, title: 'Error handling', resources: [{ title: 'Error handling', size: '150 KB', file: '/Asset/resources/js/error-handling.pdf' }] },
          { id: 5, title: 'Fetch & APIs', resources: [{ title: 'API calls', size: '170 KB', file: '/Asset/resources/js/fetch.pdf' }] },
        ],
      },
      {
        id: 3,
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'Closures', resources: [{ title: 'Closures deep dive', size: '170 KB', file: '/Asset/resources/js/closures.pdf' }] },
          { id: 2, title: 'Prototypes', resources: [{ title: 'Prototype chain', size: '180 KB', file: '/Asset/resources/js/prototypes.pdf' }] },
          { id: 3, title: 'This keyword', resources: [{ title: 'This explained', size: '160 KB', file: '/Asset/resources/js/this.pdf' }] },
          { id: 4, title: 'Functional programming', resources: [{ title: 'FP patterns', size: '200 KB', file: '/Asset/resources/js/fp.pdf' }] },
          { id: 5, title: 'Iterators & generators', resources: [{ title: 'Iterators guide', size: '180 KB', file: '/Asset/resources/js/iterators.pdf' }] },
          { id: 6, title: 'Performance', resources: [{ title: 'JS optimization', size: '170 KB', file: '/Asset/resources/js/performance.pdf' }] },
        ],
      },
    ],
    whatYouWillLearn: [
