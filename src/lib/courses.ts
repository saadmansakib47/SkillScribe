    ...
    modules: [
      {
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'ES6+ syntax', videoUrl: 'https://www.youtube.com/embed/WZQc7RUAg18', resources: [{ title: 'ES6 features', size: '180 KB', file: '/Asset/resources/js/es6.pdf' }] },
    ...
    modules: [
      {
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'Design patterns', resources: [{ title: 'Design patterns guide', size: '200 KB', file: '/Asset/resources/db/design-patterns.pdf' }] },
          { id: 2, title: 'Normalization deep dive', resources: [{ title: 'Normalization advanced', size: '180 KB', file: '/Asset/resources/db/normalization-advanced.pdf' }] },
          { id: 3, title: 'Denormalization strategies', resources: [{ title: 'Denormalization guide', size: '150 KB', file: '/Asset/resources/db/denormalization.pdf' }] },
          { id: 4, title: 'Data integrity', resources: [{ title: 'Integrity constraints', size: '120 KB', file: '/Asset/resources/db/integrity.pdf' }] },
          { id: 5, title: 'Schema evolution', resources: [{ title: 'Schema migration', size: '140 KB', file: '/Asset/resources/db/schema-evolution.pdf' }] },
        ],
      },
      {
        id: 2,
        ...
        duration: '4 hr',
        topics: [
          { id: 1, title: 'Query execution plans', resources: [{ title: 'Execution plans', size: '180 KB', file: '/Asset/resources/db/execution-plans.pdf' }] },
          { id: 2, title: 'Index optimization', resources: [{ title: 'Index strategies', size: '200 KB', file: '/Asset/resources/db/index-optimization.pdf' }] },
          { id: 3, title: 'Query rewriting', resources: [{ title: 'Query tuning', size: '150 KB', file: '/Asset/resources/db/query-rewriting.pdf' }] },
          { id: 4, title: 'Performance monitoring', resources: [{ title: 'Monitoring tools', size: '120 KB', file: '/Asset/resources/db/monitoring.pdf' }] },
          { id: 5, title: 'Caching strategies', resources: [{ title: 'Database caching', size: '160 KB', file: '/Asset/resources/db/caching.pdf' }] },
        ],
      },
      {
        id: 3,
        ...
        duration: '3.5 hr',
        topics: [
          { id: 1, title: 'Sharding', resources: [{ title: 'Sharding guide', size: '190 KB', file: '/Asset/resources/db/sharding.pdf' }] },
          { id: 2, title: 'Replication strategies', resources: [{ title: 'Replication patterns', size: '170 KB', file: '/Asset/resources/db/replication-advanced.pdf' }] },
          { id: 3, title: 'Load balancing', resources: [{ title: 'Load balancing', size: '140 KB', file: '/Asset/resources/db/load-balancing.pdf' }] },
          { id: 4, title: 'Partitioning', resources: [{ title: 'Partitioning strategies', size: '150 KB', file: '/Asset/resources/db/partitioning.pdf' }] },
        ],
      },
      {
        id: 4,
        ...
        duration: '3 hr',
        topics: [
          { id: 1, title: 'Access control', resources: [{ title: 'Access control guide', size: '130 KB', file: '/Asset/resources/db/access-control.pdf' }] },
          { id: 2, title: 'Encryption', resources: [{ title: 'Data encryption', size: '150 KB', file: '/Asset/resources/db/encryption.pdf' }] },
          { id: 3, title: 'Audit logging', resources: [{ title: 'Audit logs', size: '120 KB', file: '/Asset/resources/db/audit-logging.pdf' }] },
          { id: 4, title: 'Backup & recovery', resources: [{ title: 'Backup strategies', size: '180 KB', file: '/Asset/resources/db/backup-recovery.pdf' }] },
        ],
      },
    ],
    whatYouWillLearn: [
    ...
    modules: [
      {
        ...
        duration: '5 hr',
        topics: [
          { id: 1, title: 'Installation & setup', resources: [{ title: 'Setup guide', size: '150 KB', file: '/Asset/resources/postgres/setup.pdf' }] },
          { id: 2, title: 'Basic SQL operations', resources: [{ title: 'SQL basics', size: '180 KB', file: '/Asset/resources/postgres/sql-basics.pdf' }] },
          { id: 3, title: 'Data types', resources: [{ title: 'PostgreSQL types', size: '200 KB', file: '/Asset/resources/postgres/data-types.pdf' }] },
          { id: 4, title: 'Constraints & keys', resources: [{ title: 'Constraints guide', size: '140 KB', file: '/Asset/resources/postgres/constraints.pdf' }] },
          { id: 5, title: 'Table design', resources: [{ title: 'Table design patterns', size: '160 KB', file: '/Asset/resources/postgres/table-design.pdf' }] },
        ],
      },
      {
        id: 2,
        ...
        duration: '5 hr',
        topics: [
          { id: 1, title: 'Window functions', resources: [{ title: 'Window functions guide', size: '220 KB', file: '/Asset/resources/postgres/window-functions.pdf' }] },
          { id: 2, title: 'CTEs & subqueries', resources: [{ title: 'CTEs tutorial', size: '180 KB', file: '/Asset/resources/postgres/ctes.pdf' }] },
          { id: 3, title: 'Array operations', resources: [{ title: 'Array handling', size: '150 KB', file: '/Asset/resources/postgres/arrays.pdf' }] },
          { id: 4, title: 'JSON & JSONB', resources: [{ title: 'JSON in PostgreSQL', size: '200 KB', file: '/Asset/resources/postgres/json.pdf' }] },
          { id: 5, title: 'Full-text search', resources: [{ title: 'Text search guide', size: '190 KB', file: '/Asset/resources/postgres/full-text-search.pdf' }] },
        ],
      },
      {
        id: 3,
        ...
        duration: '5 hr',
        topics: [
          { id: 1, title: 'Index types', resources: [{ title: 'Index types guide', size: '180 KB', file: '/Asset/resources/postgres/index-types.pdf' }] },
          { id: 2, title: 'EXPLAIN & ANALYZE', resources: [{ title: 'Query analysis', size: '200 KB', file: '/Asset/resources/postgres/explain.pdf' }] },
          { id: 3, title: 'Vacuum & maintenance', resources: [{ title: 'Maintenance guide', size: '160 KB', file: '/Asset/resources/postgres/vacuum.pdf' }] },
          { id: 4, title: 'Partitioning tables', resources: [{ title: 'Table partitioning', size: '190 KB', file: '/Asset/resources/postgres/partitioning.pdf' }] },
          { id: 5, title: 'Connection pooling', resources: [{ title: 'Connection pools', size: '140 KB', file: '/Asset/resources/postgres/pooling.pdf' }] },
        ],
      },
      {
        id: 4,
        ...
        duration: '5 hr',
        topics: [
          { id: 1, title: 'Stored procedures', resources: [{ title: 'Procedures guide', size: '170 KB', file: '/Asset/resources/postgres/procedures.pdf' }] },
          { id: 2, title: 'Triggers & rules', resources: [{ title: 'Triggers tutorial', size: '180 KB', file: '/Asset/resources/postgres/triggers.pdf' }] },
          { id: 3, title: 'Extensions', resources: [{ title: 'PostgreSQL extensions', size: '200 KB', file: '/Asset/resources/postgres/extensions.pdf' }] },
          { id: 4, title: 'Replication setup', resources: [{ title: 'Replication guide', size: '220 KB', file: '/Asset/resources/postgres/replication.pdf' }] },
          { id: 5, title: 'Backup strategies', resources: [{ title: 'Backup & restore', size: '190 KB', file: '/Asset/resources/postgres/backup.pdf' }] },
        ],
      },
    ],
    whatYouWillLearn: [
