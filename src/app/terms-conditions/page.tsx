...
import { FileText, Home, ChevronRight, Calendar } from 'lucide-react';
...
export default function TermsConditionsPage() {
  ...
  useEffect(() => {
    const policy = getPolicyByType('terms');
    if (policy) {
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-lg">Please read these terms carefully before using SkillScribe</p>
              {lastUpdated && (
